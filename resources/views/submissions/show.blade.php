...
<section class="section">
    <div class="row">
                                ...
                                <div class="timeline-content flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <span class="badge bg-{{ $app->approvals_status == 1 ? 'success' : 'danger' }} ms-2">
                                                {{ $app->approvals_status == 1 ? 'Approved' : 'Rejected' }}
                                            </span>
                                        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card border-start border-primary border-4">
                <div class="card-header bg-primary bg-opacity-10">
                    <h5 class="card-title mb-0 text-primary">
                        <i class="bi bi-shield-check me-1"></i> Tindakan Approval
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="approval_notes" class="form-label fw-semibold">Catatan (Opsional)</label>
            ...
            <div class="card border-start border-info border-4">
                ...
                <div class="card-body">
                    <div class="alert alert-warning small mb-3">
                        ...
                        Pastikan saldo perusahaan mencukupi sebelum memproses pembayaran.
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="payment_notes" class="form-label fw-semibold">Catatan (Opsional)</label>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button type="button" class="btn btn-danger" id="btnRejectFinance">
                            <i class="bi bi-x-circle me-1"></i> Tolak (Saldo Tidak Cukup)
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body text-center text-muted py-4">
                    ...
                    @if($status == 7)
                        ...
                        <div class="mt-3">
                            <a href="{{ route('submissions.exportPdf', $submission->submissions_uuid) }}" class="btn btn-danger w-100" target="_blank">
                                <i class="bi bi-file-earmark-pdf-fill me-1"></i> Export PDF
                            </a>
                        </div>
                    @elseif($status == 8)
                        <span class="text-danger fw-semibold">Pengajuan ini telah ditolak (Rejected).</span>
                    @else
                        Tidak ada aksi yang tersedia untuk role Anda pada pengajuan ini.
                    @endif
                </div>
            </div>
            @endif
            ...
            <div class="mt-2">
                <a href="{{ route('submissions.index') }}" class="btn btn-outline-secondary w-100">
...
$(document).ready(function () {
    ...
    $('.btn-approve').on('click', function () {
        ...
        ajaxRequest({
            ...
            confirmMessage: 'Anda akan ' + label.toLowerCase() + ' pengajuan ini. Tindakan tidak dapat dibatalkan.',
    ...
    $('#btnPay').on('click', function () {
        ...
        ajaxRequest({
            url: '{{ route("submissions.pay", $submission->submissions_uuid) }}',
            method: 'POST',
            data: {
                action: 'pay',
